...
<head>
    ...
    <h1 style="color: seagreen"> ${msg}</h1>
</head>
...
<div class="login-reg-panel">
    ...
    <div class="white-panel">
        <div class="login-show">
            ...
            <input type="text" name="username" placeholder="Username" cssClass="text-input" autofocus="true"/>
            <form:errors path="username" cssStyle="color: crimson"></form:errors>
            <input type="password" name="password" placeholder="Password">
            <input type="password" name="passwordConfirm" cssClass="password-field"
            ...
            <div class="register-info-box">
                ...
                <div>
                    <input id="label-login" for="log-login-show" type="submit" value="Log in"
                           formaction="${pageContext.servletContext.contextPath}/login"/>
                </div>
            </div>
        </div>
    </div>
